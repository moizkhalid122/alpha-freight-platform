...
const ACCENT = "#E8650A";
const ACCENT_LIGHT = "#FF9A5C";
const DEEP = "#0A0A0C";
const CHARCOAL = "#141418";
...
const FLOW_BADGES = ["JIT-ready", "Line-side", "Aftermarket"];
...
export default function AutomotiveIndustryPage({ content }: { content: IndustryContent }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const stats = pageRef.current?.querySelector(".auto-stats");
      if (stats) {
        gsap.fromTo(
          ".auto-stat-pill",
          { y: 32, opacity: 0 },
      ...
      const showcase = pageRef.current?.querySelector(".auto-showcase");
      if (showcase) {
        gsap.fromTo(
          ".auto-showcase-head > *",
          { y: 40, opacity: 0 },
        ...
        gsap.from(".auto-showcase-card", {
          y: 48,
          opacity: 0,
          duration: 1,
          stagger: 0.12,
          ease: "power3.out",
          scrollTrigger: { trigger: showcase.querySelector(".auto-showcase-grid"), start: "top 88%" },
        });
      }

      pageRef.current?.querySelectorAll(".auto-section").forEach((section) => {
        const items = section.querySelectorAll(".auto-reveal");
      ...
      pageRef.current?.querySelectorAll(".auto-timeline-step").forEach((step, i) => {
        gsap.fromTo(
          step,
  ...
  return (
    <div
      ref={pageRef}
      className={`${cormorant.variable} ${dmSans.variable} min-h-screen overflow-x-hidden bg-[#F4F4F6] font-[family-name:var(--font-auto-sans)] text-[#0A0A0C] selection:bg-[#FFD4B8] selection:text-[#0A0A0C]`}
    ...
    >
      ...
      <JsonLd
        data={{
          ...
          serviceType: "Automotive parts freight and haulage",
        }}
      />
      <JsonLd
        data={{
      ...
      <main>
        <section ref={heroRef} className="relative min-h-[100svh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#0A0A0C]/70 via-[#0A0A0C]/45 to-[#0A0A0C]/88" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0A0A0C]/50 via-transparent to-[#141418]/35" />
          ...
          <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[920px] flex-col items-center justify-center px-6 pb-16 pt-32 text-center lg:px-10">
            <div className="auto-hero-reveal inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 backdrop-blur-md">
            ...
            <h1
              className="auto-hero-reveal mt-7 max-w-[720px] text-[clamp(2.25rem,5vw,3.75rem)] font-medium leading-[1.08] tracking-[-0.02em] text-white"
              style={{ fontFamily: "var(--font-auto-serif), Georgia, serif" }}
            >
              {headline.before}
              {headline.accent ? (
            ...
            <p className="auto-hero-reveal mx-auto mt-5 max-w-[560px] text-[14px] leading-[1.75] text-white/70 sm:text-[16px]">
              {content.heroSubtitle}
            </p>

            <div className="auto-hero-reveal mt-6 flex flex-wrap items-center justify-center gap-2">
              {FLOW_BADGES.map((badge) => (
                <span
                  key={badge}
                  className="auto-flow-badge inline-flex items-center gap-1.5 rounded-full border border-white/12 bg-white/8 px-3.5 py-1.5 text-[11px] font-medium tracking-wide text-white/85 backdrop-blur-sm"
                >
                  <Gauge className="h-3 w-3" style={{ color: ACCENT_LIGHT }} />
                  {badge}
                </span>
              ))}
            </div>

            <div className="auto-hero-reveal mt-9 flex flex-wrap items-center justify-center gap-3">
              <Link
        ...
        {content.milestones ? (
          <section className="auto-stats relative overflow-hidden px-6 py-14 lg:px-12" style={{ backgroundColor: DEEP }}>
            <div
              className="pointer-events-none absolute inset-0 opacity-50"
              style={{
                background: `radial-gradient(ellipse 70% 80% at 50% 0%, rgba(232,101,10,0.2), transparent 65%)`,
              }}
            />
              ...
              <div className="mt-10 grid grid-cols-2 gap-3 lg:grid-cols-4 lg:gap-4">
                {content.milestones.items.map((item) => {
                  ...
                  return (
                    <div
                      key={item.label}
                      className="auto-stat-pill rounded-2xl border border-white/10 bg-white/[0.06] px-5 py-7 backdrop-blur-sm sm:px-6 sm:py-8"
                    >
        ...
        {content.showcase ? (
          <section className="auto-showcase px-6 py-20 sm:py-24 lg:px-12 lg:py-28">
            <div className="mx-auto max-w-[1180px]">
              <div className="auto-showcase-head mx-auto max-w-[580px] text-center">
                ...
                <h2
                  ...
                  style={{ fontFamily: "var(--font-auto-serif), Georgia, serif", color: DEEP }}
                >
              ...
              <div className="auto-showcase-grid mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:mt-16 lg:gap-6">
                {content.showcase.items.map((item) => (
                  <article
                    key={item.title}
                    className="auto-showcase-card group relative overflow-hidden rounded-2xl"
                  >
                    <div
                    ...
                    >
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0C]/90 via-[#0A0A0C]/20 to-transparent opacity-80 transition group-hover:opacity-90" />
        ...
        {content.blackFeature ? (
          <section className="auto-section relative overflow-hidden px-6 py-20 lg:px-12 lg:py-24" style={{ backgroundColor: CHARCOAL }}>
            <div
              className="pointer-events-none absolute inset-0"
              style={{
                background: `radial-gradient(ellipse 60% 50% at 80% 20%, rgba(232,101,10,0.14), transparent 55%), radial-gradient(ellipse 50% 40% at 10% 90%, rgba(148,163,184,0.12), transparent 50%)`,
              }}
            />
            <div className="relative mx-auto grid max-w-[1180px] gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
              <div className="auto-reveal">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/10 px-3 py-1.5">
                  <Wrench className="h-3.5 w-3.5" style={{ color: ACCENT_LIGHT }} />
              ...
              <div className="auto-reveal rounded-2xl border border-white/10 bg-white/[0.05] p-8 backdrop-blur-sm lg:self-center">
                <ShieldCheck className="h-5 w-5" style={{ color: STEEL }} />
                <p className="mt-4 text-[10px] font-semibold uppercase tracking-[0.2em]" style={{ color: STEEL }}>
                  Marketplace pricing
                </p>
                <p
                ...
                <p className="mt-3 text-[13px] leading-relaxed text-white/50">
                  No monthly subscription. Compare verified automotive carrier bids and pay securely when your load goes live.
                </p>
                <Link
                  href="/pricing"
        ...
        <section className="auto-section px-6 py-20 lg:px-12 lg:py-24" style={{ backgroundColor: SURFACE }}>
          <div className="mx-auto max-w-[1180px]">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {content.informationPoints.map((point, i) => (
                  <div
                    key={point.title}
                    className="auto-reveal rounded-2xl border border-[#E8EAED] bg-white p-6 transition-shadow duration-500 hover:shadow-md"
        ...
        <section className="auto-section px-6 py-20 lg:px-12" style={{ backgroundColor: "#FAFAFB" }}>
          <div className="mx-auto max-w-[1180px]">
            <div className="auto-reveal max-w-xl">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em]" style={{ color: ACCENT }}>
                Capabilities
              </p>
              <h2
            ...
            <div className="mt-12 grid gap-4 lg:grid-cols-2">
              {content.capabilities.map((cap) => (
                <div
                  key={cap.title}
                  className="auto-reveal group rounded-2xl bg-white p-7 shadow-sm transition duration-500 hover:-translate-y-1 hover:shadow-lg sm:p-8"
                >
                  <div
            ...
            <div className="auto-reveal mt-10">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {content.equipment.map((item) => (
                  <span
                    key={item}
                    className="rounded-full border border-[#E8EAED] bg-white px-4 py-2 text-[12px] font-medium text-[#0A0A0C]"
                  >
                    {item}
                  </span>
                ))}
        ...
        <section className="auto-section px-6 py-20 lg:px-12 lg:py-24" style={{ backgroundColor: SURFACE }}>
          <div className="mx-auto max-w-[760px]">
            <div className="auto-reveal text-center">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em]" style={{ color: ACCENT }}>
                Step by step
              </p>
              <h2
            ...
            <div className="relative mt-14">
              <div className="absolute bottom-0 left-[19px] top-0 w-px bg-[#E8EAED] sm:left-[23px]" />
              <div className="space-y-6">
                {content.processSteps.map((step) => (
                  <div key={step.step} className="auto-timeline-step relative flex gap-5 pl-0 sm:gap-6">
                    <div
                    ...
                    <div className="min-w-0 flex-1 rounded-2xl border border-[#E8EAED]/80 bg-white px-5 py-5 sm:px-6 sm:py-6">
                      <h3
        ...
        <section className="auto-section px-6 py-20 lg:px-12" style={{ backgroundColor: "#FAFAFB" }}>
          <div className="mx-auto max-w-[720px]">
            ...
            <div className="auto-reveal mt-8 space-y-3">
              {content.faqs.map((faq, index) => {
                const open = openFaq === index;
                return (
                  <div key={faq.q} className="overflow-hidden rounded-2xl border border-[#E8EAED]/80 bg-white">
                    <button
                      type="button"
                    ...
                    >
                      <span
                        ...
                        style={{
                          fontFamily: open ? "var(--font-auto-serif), Georgia, serif" : undefined,
                          color: DEEP,
                        }}
                      >
                        {faq.q}
        ...
        <section className="auto-section px-6 py-20 lg:px-12" style={{ backgroundColor: SURFACE }}>
          <div className="mx-auto max-w-[1180px]">
            <div className="auto-reveal flex flex-wrap items-end justify-between gap-4">
              <div>
                <p className="text-[10px] font-semibold uppercase tracking-[0.22em]" style={{ color: ACCENT }}>
                  More industries
                </p>
              ...
              {related.map((item) => {
                ...
                return (
                  <Link
                    key={item.slug}
                    href={item.path}
                    className="auto-reveal group rounded-2xl border border-[#E8EAED]/80 bg-white p-6 transition duration-500 hover:-translate-y-1 hover:shadow-md"
                  >
