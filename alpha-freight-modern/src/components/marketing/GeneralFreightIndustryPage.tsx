...
const FLOW_BADGES = ["Free to post", "Pallet haulage", "UK-wide"];
...
export default function GeneralFreightIndustryPage({ content }: { content: IndustryContent }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const stats = pageRef.current?.querySelector(".gf-stats");
      if (stats) {
        gsap.fromTo(
          ".gf-stat-pill",
          { y: 32, opacity: 0 },
      ...
      const showcase = pageRef.current?.querySelector(".gf-showcase");
      if (showcase) {
        gsap.fromTo(
          ".gf-showcase-head > *",
          { y: 40, opacity: 0 },
        ...
        gsap.from(".gf-showcase-card", {
          y: 48,
          opacity: 0,
          duration: 1,
          stagger: 0.12,
          ease: "power3.out",
          scrollTrigger: { trigger: showcase.querySelector(".gf-showcase-grid"), start: "top 88%" },
        });
      }

      pageRef.current?.querySelectorAll(".gf-section").forEach((section) => {
        const items = section.querySelectorAll(".gf-reveal");
      ...
      pageRef.current?.querySelectorAll(".gf-timeline-step").forEach((step, i) => {
        gsap.fromTo(
          step,
  ...
  return (
    <div
      ref={pageRef}
      className={`${cormorant.variable} ${dmSans.variable} min-h-screen overflow-x-hidden bg-[#F8FAFC] font-[family-name:var(--font-gf-sans)] text-[#0F172A] selection:bg-[#CBD5E1] selection:text-[#0F172A]`}
      style={{ "--gf-accent": ACCENT } as CSSProperties}
    >
      <JsonLd
        data={{
      ...
      <JsonLd
        data={{
          ...
          serviceType: "General freight and pallet haulage",
        }}
      />
      <JsonLd
        data={{
      ...
      <main>
        <section ref={heroRef} className="relative min-h-[100svh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#0F172A]/70 via-[#0F172A]/45 to-[#0F172A]/88" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0F172A]/50 via-transparent to-[#1E293B]/35" />
          ...
          <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[920px] flex-col items-center justify-center px-6 pb-16 pt-32 text-center lg:px-10">
            <div className="gf-hero-reveal inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 backdrop-blur-md">
            ...
            <h1
              className="gf-hero-reveal mt-7 max-w-[720px] text-[clamp(2.25rem,5vw,3.75rem)] font-medium leading-[1.08] tracking-[-0.02em] text-white"
              style={{ fontFamily: "var(--font-gf-serif), Georgia, serif" }}
            >
              {headline.before}
              {headline.accent ? (
            ...
            <p className="gf-hero-reveal mx-auto mt-5 max-w-[560px] text-[14px] leading-[1.75] text-white/70 sm:text-[16px]">
              {content.heroSubtitle}
            </p>

            <div className="gf-hero-reveal mt-6 flex flex-wrap items-center justify-center gap-2">
              {FLOW_BADGES.map((badge) => (
                <span
                  key={badge}
                  className="gf-flow-badge inline-flex items-center gap-1.5 rounded-full border border-white/12 bg-white/8 px-3.5 py-1.5 text-[11px] font-medium tracking-wide text-white/85 backdrop-blur-sm"
                >
            ...
            <div className="gf-hero-reveal mt-9 flex flex-wrap items-center justify-center gap-3">
              <Link
        ...
        {content.milestones ? (
          <section className="gf-stats relative overflow-hidden px-6 py-14 lg:px-12" style={{ backgroundColor: DEEP }}>
            <div
              className="pointer-events-none absolute inset-0 opacity-50"
              style={{
                background: `radial-gradient(ellipse 70% 80% at 50% 0%, rgba(51,65,85,0.2), transparent 65%)`,
              }}
            />
              ...
              <div className="mt-10 grid grid-cols-2 gap-3 lg:grid-cols-4 lg:gap-4">
                {content.milestones.items.map((item) => {
                  ...
                  return (
                    <div
                      key={item.label}
                      className="gf-stat-pill rounded-2xl border border-white/10 bg-white/[0.06] px-5 py-7 backdrop-blur-sm sm:px-6 sm:py-8"
                    >
        ...
        {content.showcase ? (
          <section className="gf-showcase px-6 py-20 sm:py-24 lg:px-12 lg:py-28">
            <div className="mx-auto max-w-[1180px]">
              <div className="gf-showcase-head mx-auto max-w-[580px] text-center">
                ...
                <h2
                  ...
                  style={{ fontFamily: "var(--font-gf-serif), Georgia, serif", color: DEEP }}
                >
              ...
              <div className="gf-showcase-grid mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:mt-16 lg:gap-6">
                {content.showcase.items.map((item) => (
                  <article
                    key={item.title}
                    className="gf-showcase-card group relative overflow-hidden rounded-2xl"
                  >
                    <div
                    ...
                    >
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#0F172A]/90 via-[#0F172A]/20 to-transparent opacity-80 transition group-hover:opacity-90" />
        ...
        {content.blackFeature ? (
          <section className="gf-section relative overflow-hidden px-6 py-20 lg:px-12 lg:py-24" style={{ backgroundColor: CHARCOAL }}>
            <div
              className="pointer-events-none absolute inset-0"
              style={{
                background: `radial-gradient(ellipse 60% 50% at 80% 20%, rgba(51,65,85,0.14), transparent 55%), radial-gradient(ellipse 50% 40% at 10% 90%, rgba(148,163,184,0.12), transparent 50%)`,
              }}
            />
            <div className="relative mx-auto grid max-w-[1180px] gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
              <div className="gf-reveal">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/10 px-3 py-1.5">
                  <ClipboardList className="h-3.5 w-3.5" style={{ color: ACCENT_LIGHT }} />
              ...
              <div className="gf-reveal rounded-2xl border border-white/10 bg-white/[0.05] p-8 backdrop-blur-sm lg:self-center">
                ...
                <p className="mt-3 text-[13px] leading-relaxed text-white/50">
                  No monthly subscription. Compare verified general freight carrier bids and pay securely when your load goes live.
                </p>
                <Link
                  href="/pricing"
        ...
        <section className="gf-section px-6 py-20 lg:px-12 lg:py-24" style={{ backgroundColor: SURFACE }}>
          <div className="mx-auto max-w-[1180px]">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {content.informationPoints.map((point, i) => (
                  <div
                    key={point.title}
                    className="gf-reveal rounded-2xl border border-[#E2E8F0] bg-white p-6 transition-shadow duration-500 hover:shadow-md"
        ...
        <section className="gf-section px-6 py-20 lg:px-12" style={{ backgroundColor: "#F1F5F9" }}>
          <div className="mx-auto max-w-[1180px]">
            <div className="gf-reveal max-w-xl">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em]" style={{ color: ACCENT }}>
                Capabilities
              </p>
              <h2
            ...
            <div className="mt-12 grid gap-4 lg:grid-cols-2">
              {content.capabilities.map((cap) => (
                <div
                  key={cap.title}
                  className="gf-reveal group rounded-2xl bg-white p-7 shadow-sm transition duration-500 hover:-translate-y-1 hover:shadow-lg sm:p-8"
                >
                  <div
            ...
            <div className="gf-reveal mt-10">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {content.equipment.map((item) => (
                  <span
                    key={item}
                    className="rounded-full border border-[#E2E8F0] bg-white px-4 py-2 text-[12px] font-medium text-[#0F172A]"
                  >
                    {item}
                  </span>
                ))}
        ...
        <section className="gf-section px-6 py-20 lg:px-12 lg:py-24" style={{ backgroundColor: SURFACE }}>
          <div className="mx-auto max-w-[760px]">
            <div className="gf-reveal text-center">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em]" style={{ color: ACCENT }}>
                Step by step
              </p>
              <h2
            ...
            <div className="relative mt-14">
              <div className="absolute bottom-0 left-[19px] top-0 w-px bg-[#E2E8F0] sm:left-[23px]" />
              <div className="space-y-6">
                {content.processSteps.map((step) => (
                  <div key={step.step} className="gf-timeline-step relative flex gap-5 pl-0 sm:gap-6">
                    <div
                    ...
                    <div className="min-w-0 flex-1 rounded-2xl border border-[#E2E8F0]/80 bg-white px-5 py-5 sm:px-6 sm:py-6">
                      <h3
        ...
        <section className="gf-section px-6 py-20 lg:px-12" style={{ backgroundColor: "#F1F5F9" }}>
          <div className="mx-auto max-w-[720px]">
            ...
            <div className="gf-reveal mt-8 space-y-3">
              {content.faqs.map((faq, index) => {
                const open = openFaq === index;
                return (
                  <div key={faq.q} className="overflow-hidden rounded-2xl border border-[#E2E8F0]/80 bg-white">
                    <button
                      type="button"
                    ...
                    >
                      <span
                        ...
                        style={{
                          fontFamily: open ? "var(--font-gf-serif), Georgia, serif" : undefined,
                          color: DEEP,
                        }}
                      >
                        {faq.q}
        ...
        <section className="gf-section px-6 py-20 lg:px-12" style={{ backgroundColor: SURFACE }}>
          <div className="mx-auto max-w-[1180px]">
            <div className="gf-reveal flex flex-wrap items-end justify-between gap-4">
              <div>
                <p className="text-[10px] font-semibold uppercase tracking-[0.22em]" style={{ color: ACCENT }}>
                  More industries
                </p>
              ...
              {related.map((item) => {
                ...
                return (
                  <Link
                    key={item.slug}
                    href={item.path}
                    className="gf-reveal group rounded-2xl border border-[#E2E8F0]/80 bg-white p-6 transition duration-500 hover:-translate-y-1 hover:shadow-md"
                  >
