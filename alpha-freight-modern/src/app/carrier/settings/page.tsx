...
const SETTINGS_KEY = "carrier-notification-prefs";
    ...
    <div className="w-full space-y-6 p-4 sm:p-6 lg:px-8">
      ...
      >
        <div className="flex items-center gap-3 border-b border-slate-100 px-5 py-4 sm:px-6">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500">Fleet details and public carrier profile</p>
          </div>
        </div>
        <div className="divide-y divide-slate-100">
          ...
          <div className="flex flex-col gap-3 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div>
              <p className="text-[13px] font-semibold text-slate-900">Carrier profile</p>
              <p className="text-[12px] text-slate-500">Name, fleet, documents, and verification</p>
            </div>
            <Link
      ...
      >
        ...
        <div className="divide-y divide-slate-100">
          {[
            {
              key: "loadAlerts" as const,
              label: "Smart load alerts",
              desc: "Notify when new loads match your fleet",
            },
            {
              key: "bidUpdates" as const,
              label: "Bid updates",
              desc: "Real-time updates on your marketplace offers",
            },
            {
              key: "weeklyReports" as const,
              label: "Weekly summary",
              desc: "Earnings and activity digest every Monday",
            },
          ].map((item) => (
            <div
              key={item.key}
