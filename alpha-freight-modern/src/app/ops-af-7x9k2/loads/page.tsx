  ...
  if (variant === "compact") {
    return (
      <div className="flex items-center gap-1">
        ...
        {row.supplierId ? (
          <Link
            href={`/ops-af-7x9k2/suppliers/${row.supplierId}`}
            title="View supplier"
            className={iconClass}
          >
        ...
        {row.carrierId ? (
          <Link href={`/ops-af-7x9k2/carriers/${row.carrierId}`} title="View carrier" className={iconClass}>
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex gap-1">
        ...
        {row.carrierId ? (
          <Link href={`/ops-af-7x9k2/carriers/${row.carrierId}`} title="Carrier" className={cn(iconClass, "h-8 w-8")}>
      ...
      <section className={cn(CARD_CLASS, "relative overflow-hidden p-6")}>
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/ops-af-7x9k2/post-load">
              <Button size="sm">
                  ...
                  {paginatedRows.map((row, index) => (
                    <tr key={row.id} className="group border-t border-slate-100 align-top hover:bg-slate-50/60">
                      ...
                      <td className="px-3 py-2.5 align-top">
                        {row.carrierId ? (
                          <Link
                            href={`/ops-af-7x9k2/carriers/${row.carrierId}`}
