  ...
  if (variant === "compact") {
    return (
      <div className="flex items-center gap-1">
        ...
        <Link href={`/ops-af-7x9k2/suppliers/add?edit=${row.id}`} title="Edit" className={iconClass}>
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex gap-1">
        ...
        <Link href={`/ops-af-7x9k2/suppliers/add?edit=${row.id}`} title="Edit" className={cn(iconClass, "h-8 w-8")}>
      ...
      <section className={cn(CARD_CLASS, "relative overflow-hidden p-6")}>
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/ops-af-7x9k2/suppliers/active">
            ...
            <Link href="/ops-af-7x9k2/suppliers/add">
              <Button size="sm">
