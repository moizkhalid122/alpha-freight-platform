  ...
  if (variant === "compact") {
    return (
      <div className="flex items-center gap-1">
        ...
        <Link href={`/ops-af-7x9k2/carriers/${row.id}/edit`} title="Edit" className={iconClass}>
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex gap-1">
        <Link href={`/ops-af-7x9k2/carriers/${row.id}/edit`} title="Edit" className={cn(iconClass, "h-8 w-8")}>
      ...
      <section className={cn(CARD_CLASS, "relative overflow-hidden p-6")}>
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link href="/ops-af-7x9k2/carriers/pending-verifications">
            ...
            <Link href="/ops-af-7x9k2/carriers/add">
              ...
              <div key={row.id} className="relative overflow-hidden rounded-xl bg-slate-50/80 p-5 ring-1 ring-slate-200/60">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <Link href={`/ops-af-7x9k2/carriers/${row.id}`} className="text-lg font-semibold text-slate-900 hover:text-emerald-700">
                        {row.companyName}
                      </Link>
