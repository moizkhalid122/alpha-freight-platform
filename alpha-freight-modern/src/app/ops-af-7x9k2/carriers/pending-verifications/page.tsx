                    ...
                    <td className="px-3 py-3 align-top">
                      <div className="flex items-start gap-2.5">
                        ...
                        <div className="min-w-0">
                          <Link href={`/ops-af-7x9k2/carriers/${row.id}`} className="block truncate font-semibold text-slate-900 hover:text-emerald-700" title={row.companyName}>
                            {row.companyName}
                          </Link>
        ...
        {expandedRow ? (
          <div className="mt-6 rounded-xl bg-slate-50/80 p-5 ring-1 ring-slate-200/60">
            <div className="mb-5 flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <Link href={`/ops-af-7x9k2/carriers/${expandedRow.id}`}><Button size="sm">View profile</Button></Link>
