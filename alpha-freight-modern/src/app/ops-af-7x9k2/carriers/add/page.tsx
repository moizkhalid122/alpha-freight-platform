...
export default function AdminAddCarrierPage() {
  ...
  const saveCarrier = async (mode: "list" | "another") => {
    ...
    try {
      ...
      router.push("/ops-af-7x9k2/carriers");
    } catch (error) {
        ...
        <div className="border-b border-slate-200/90 bg-gradient-to-b from-white to-slate-50/80 p-5">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button variant="secondary" size="sm" onClick={() => router.push("/ops-af-7x9k2/carriers")}>
                Cancel
              </Button>
      ...
      <section className={cn(ADMIN_CARD, "p-5")}>
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button variant="secondary" onClick={() => router.push("/ops-af-7x9k2/carriers")} disabled={isSaving}>
              Cancel
            </Button>
          </div>
        </div>
