...
> = {
  "quick-stats": {
    ...
    relatedLinks: [
      { label: "Open carriers", href: "/ops-af-7x9k2/carriers" },
      { label: "Open suppliers", href: "/ops-af-7x9k2/suppliers" },
    ],
  },
  "carriers": {
    ...
    relatedLinks: [
      { label: "Pending verification", href: "/ops-af-7x9k2/carriers/pending-verifications" },
      { label: "Carrier performance", href: "/ops-af-7x9k2/carriers/performance" },
    ],
  },
  "carriers/add": {
    eyebrow: "Add Carrier",
  ...
  "suppliers": {
    ...
    relatedLinks: [
      { label: "Active suppliers", href: "/ops-af-7x9k2/suppliers/active" },
      { label: "Supplier loads", href: "/ops-af-7x9k2/suppliers/loads" },
    ],
  },
  "suppliers/add": {
