      ...
      <div className="mx-auto max-w-2xl space-y-6">
        <section className={cn(CARD_CLASS, "p-8 text-center")}>
          ...
          <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:justify-center">
            <Button onClick={() => router.push(`/ops-af-7x9k2/loads/${postedLoadId}`)}>View load</Button>
            <Button variant="secondary" onClick={() => router.push("/ops-af-7x9k2/loads")}>
              All loads
            </Button>
            <Button
              variant="secondary"
    ...
    <div className="mx-auto max-w-[920px] space-y-6">
      ...
      <form onSubmit={handleSubmit} className={cn(CARD_CLASS, "space-y-6 p-6")}>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button type="button" variant="secondary" onClick={() => router.push("/ops-af-7x9k2/loads")}>
            Cancel
          </Button>
        </div>
      </form>
