...
const benefits = [
  {
    ...
    description: "Publish freight requirements, manage bids, and award trusted carriers from one supplier command center.",
  },
  {
    icon: LineChart,
    title: "Track every shipment live",
    description: "Monitor active loads with GPS visibility, status history, and proof-of-delivery confidence.",
  },
  {
    icon: ShieldCheck,
    title: "Work with verified carriers",
    description: "Award jobs to vetted partners with ratings, compliance signals, and transparent workflows.",
  },
];

const steps = ["Create your supplier account", "Post your first load", "Review bids and award", "Track delivery to POD"];
...
export default function SupplierSignupPage() {
  return (
    <div className="min-h-screen bg-black text-white selection:bg-[#BFFF07] selection:text-black overflow-x-hidden">
      ...
      <main className="pt-28 md:pt-32">
        <section className="relative pb-24 md:pb-32 overflow-hidden border-b border-white/10">
          <div className="absolute inset-0">
            <Image src="/alpha-box.jpg" alt="" fill className="object-cover opacity-35" />
          ...
          <div className="relative max-w-[1800px] mx-auto px-6 lg:px-12 grid lg:grid-cols-[1.1fr_0.9fr] gap-14 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-[5.5rem] font-medium leading-[0.92] tracking-tighter uppercase">
                Ship smarter.
                <br />
                <span className="text-white/25">Post with confidence.</span>
              </h1>
              <p className="mt-8 text-white/45 text-lg max-w-xl leading-relaxed">
                Join Alpha Freight as a supplier and move cargo through a modern marketplace built for speed, visibility, and trusted carrier partnerships.
              </p>

              <div className="mt-10 flex flex-wrap gap-4">
                <Link
                  href="/auth/signup?role=supplier"
                  className="inline-flex items-center gap-2 rounded-full bg-[#BFFF07] px-8 py-4 text-[11px] font-bold uppercase tracking-[0.2em] text-black hover:bg-white transition-colors"
                >
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#BFFF07] text-black">
                  <Truck className="h-6 w-6" />
                </div>
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/40">Setup flow</p>
                  <p className="text-xl font-medium">Go live in four steps</p>
                </div>
              </div>
      ...
      <CinematicCTA
        title="Ready to post your next load?"
        subtitle="Start as a supplier"
